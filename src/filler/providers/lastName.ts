...
export const lastNameGenerator = new StaticDataGenerator({
  ...
  pl: [
    'Nowak', 'Kowalski', 'Wiśniewski', 'Wójcik', 'Kowalczyk', 'Kamińska', 'Lewandowski', 'Zielińska', 'Szymański', 'Woźniak',
    'Dąbrowski', 'Kozłowska', 'Jankowski', 'Mazur', 'Wojciechowski', 'Kwiatkowska', 'Krawczyk', 'Piotrowska', 'Grabowski', 'Nowakowska',
    'Pawłowski', 'Michalska', 'Adamczyk', 'Dudek', 'Zając', 'Wieczorek', 'Jabłońska', 'Król', 'Majewski', 'Baran',
  ],
  de: [
